...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table width="700" class="table-list" border="0" cellspacing="1" cellpadding="3">
    <tr>
      <td colspan="3" bgcolor="#F5F5F5"><b>TAMBAH DATA ADMIN </b></td>
    </tr>
    <tr>
      <td width="183"><b>Kode</b></td>
      <td width="5"><b>:</b></td>
      <td width="490"><input name="textfield" type="text" value="<?php echo $dataKode; ?>" size="10" maxlength="10" readonly="readonly"/></td>
    </tr>
    <tr>
