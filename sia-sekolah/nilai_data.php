  ...
  <tr>
    <td><table  class="table-list" width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
        ...
        <th width="10%" bgcolor="#CCCCCC"><strong>NIS</strong></th>
        <th width="27%" bgcolor="#CCCCCC"><strong>Nama Siswa</strong></th>
        ...
        <th width="7%" bgcolor="#CCCCCC"><strong>UTS</strong></th>
        <th width="7%" bgcolor="#CCCCCC"><strong>UAS</strong></th>
