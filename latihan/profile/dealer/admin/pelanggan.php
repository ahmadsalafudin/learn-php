...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Daihatsu Purworejo | Galeri Pelanggan</title>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                ...
                                <div class="box-body table-responsive">
                                        ...
                                        <tbody>
											<?php
												...
												while ($row = $customers->fetch_assoc()) {
                                                    ...
                                                    ?>
                                                     <a class='btn btn-sm btn-primary' href="edit-pelanggan.php?id=<?php echo $row['id_c'];?>"><i class="fa fa-pencil"></i> Edit</a>
                                                    <a class='btn btn-sm btn-danger' href="del-pelanggan.php?id=<?php echo $row['id_c'];?>" onClick="return confirm('Anda yakin akan DELETE data <?php echo $i-1;?> atas nama <?php echo $row['id_c'];?> ?');"><i class="fa fa-times"></i> Del</a></td>
                                                    <?php
                                                    echo '</tr>';
                                    ...
                                    <a class="btn btn-primary" href="form-pelanggan.php"><i class="fa fa-plus-square"></i>Tambah Data Pelanggan</a>
                            </div>
                        </div>
                    </div>
