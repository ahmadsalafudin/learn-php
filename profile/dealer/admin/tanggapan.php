...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Daihatsu Purworejo | Tanggapan</title>
    ...
    <body class="skin-blue">
        ...
        <aside class="right-side">                
				...
				<?php
					include 'config.php';
					$komentar = $mysqli->query("select * from komentar");
					if(!$komentar){
                                        ...
                                        <tbody>
											<?php
												...
												while ($row = $komentar->fetch_assoc()) {
                                                    ...
                                                    ?>
                                                    <a class='btn btn-sm btn-danger' href="del-komentar.php?id=<?php echo $row['id_produk'];?>" onClick="return confirm('Anda yakin akan DELETE data <?php echo $i-1;?> atas nama <?php echo $row['komentar'];?> ?');"><i class="fa fa-times"></i> Del</a></td>
                                                    <?php
                                                    echo '</tr>';
