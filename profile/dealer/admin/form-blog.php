...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Daihtsu Purworejo | Tambah Artikel</title>
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                       <li><a href="home.php"> Dashboard</a></li>
						...
						<li class="active">Tambah Artikel</a></li>
                    </ol>
                </section>
				   ...
				   <div class="row">
                        <div class="col-md-6">
                            <div class="box box-primary">
                                ...
                                <form role="form" method="post" action="add-blog.php">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Judul</label>
                                             <input class="form-control" placeholder="Judul" name="title_blog" id="title_blog">
                                            </input>
                                        </div>
										<div class="form-group">
                                          <label for="exampleInputEmail1">Isi</label>
                                             <textarea class="ckeditor" placeholder="Isi Artikel" name="isi_blog" id="isi_blog" required></textarea>
                                            </input>
                                        </div>
                                        <div class="form-group">
