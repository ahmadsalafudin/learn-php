...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Daihatsu Purworejo | Pesan Masuk</title>
    ...
    <body class="skin-blue">
        ...
        <aside class="right-side">                
				...
				<?php
					include 'config.php';
					$pesan = $mysqli->query("select * from pesan");
					if(!$pesan){
                                        ...
                                        <tbody>
											<?php
												...
												while ($row = $pesan->fetch_assoc()) {
                                                    ...
                                                    ?>
                                                    <a class='btn btn-sm btn-danger' href="del-pesan.php?id=<?php echo $row['id_p'];?>" onClick="return confirm('Anda yakin akan DELETE data <?php echo $i-1;?> atas nama <?php echo $row['id_p'];?> ?');"><i class="fa fa-times"></i> Del</a></td>
                                                    <?php
                                                    echo '</tr>';
