...
include "koneksi.php";
$ambil_data = mysql_query("select * from berita1 order by id_berita desc limit $offset, $dataPerPage",$koneksi);
$hitung_record = mysql_query("SELECT COUNT(*) AS jumData FROM berita1",$koneksi);
