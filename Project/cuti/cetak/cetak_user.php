...
$header = array('No.', 'Nama User','No. Telepon', 'Username', 'Level');

// Load Data dari Database
$dataku = mysql_query("SELECT * FROM user");
$no = 0;
	while ($tampil=mysql_fetch_array($dataku)){
	$no++;
	// Simpan Kedalam Array dengan Batasan |
	@$gue[] .= $no."|".$tampil['nm_user']."|".$tampil['no_telepon']."|".$tampil['username']."|".$tampil['level'];
	 }
	 // Cetak Laporan
