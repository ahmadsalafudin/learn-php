    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<section class="content">
		  ...
		  <div class="row">
  <div class="col-lg-12">
    <center><h3>Selamat Datang HRD</h3></center>
  
  </div>
</div>
    <div class="row" style="padding-top: 50px; font-size: 40px; font-family:cambria;">
	  <div>
              <center><img src="lukman.png" class="img-circle" alt="User Image" /></center>
            </div>
      <div>
         <p><center><h4>SISTEM PENGAJUAN CUTI</h4></center></p>
		 <p><center><h4>PT. SARI TAKAGI ELOK PRODUK (PT. STEP)</h4></center></p>
      </div>
    </div>
