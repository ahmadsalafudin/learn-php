...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table class="table-list" width="700" border="0" cellspacing="1" cellpadding="3">
    <tr>
      <td colspan="3" bgcolor="#CCCCCC"><strong>MEMBUAT KELAS</strong></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="2%"><b>:</b></td>
      <td><input name="textfield" value="<?php echo $dataKode; ?>" size="10" maxlength="10" readonly="readonly"/></td>
    </tr>
    <tr>
  ...
  <table width="700" border="0" cellspacing="1" cellpadding="3">
    <tr class="table-list">
      ...
      <td width="60" bgcolor="#F5F5F5"><strong>NIS</strong></td>
      <td width="193" bgcolor="#F5F5F5"><strong>Nama Siswa </strong></td>
