...
echo '<title>Data Mahasiswa - Absen In</title>';
			...
			<section class="box-typical">
				<header class="box-typical-header">
					<div class="tbl-row">
						...
						<form  id="form-insert" name="form-insert" method="get" action="search/g-mahasiswa.php">
							...
							<tbody>
								...
								<td align="center">
									<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
										<a href="page.php?g-detail-mahasiswa&id=<?php echo $data['id_mahasiswa'];?>" class="btn btn btn-default" data-toggle="tooltip" data-placement="top" title="Detail?"><i class="font-icon font-icon-eye"></i> </a>
									</div>
								</td>
								</tr>
	 							<?php 
					...
					<div class="col-md-6" align="right">
						<nav>
							<ul class="pagination">
								...
								<a class='page-link' href='page.php?g-data-mahasiswa&kelas=$nm_kelas&pg=$link' aria-label='Previous'>
								...
								$nmr.= "<li class='page-item'><a class='page-link' href='page.php?g-data-mahasiswa&kelas=$nm_kelas&pg=$i'>$i</a></li>";
								}
								}
								...
								<a class='page-link' href='page.php?g-data-mahasiswa&kelas=$nm_kelas&pg=$link'aria-label='Next'>
