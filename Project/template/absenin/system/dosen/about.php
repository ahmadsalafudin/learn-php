		...
		<div class="container-fluid">
			<div class="box-typical box-typical-padding documentation">
				...
				<div class="text-block text-block-typical">
					<p>Aplikasi ini bernama AbsenKit atau absensi mahasiswa berbasis web.  Sengaja dibuat oleh admin (Husni Mubarok) bertujuan sebagai salah satu syarat mengikuti kegiatan Uji Kompetensi disekolahnya (SMK Yapinda).</p>
				 	<p>Fungsi dari AbsenKit ini adalah menyimpan data absensi mahasiswa kemudian disimpan ke database. Aplikasi ini juga dapat menampilkan data absensi mahasiswa yang sebelumnya telah dibuat. </p>
