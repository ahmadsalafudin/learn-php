		...
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding documentation">
			  	<header class="documentation-header">
					<h5 align="center" class="with-border m-t-lg"><strong>Cara Menggunakan Absenin (Absensi Mahasiswa Berbasis Web) </strong></h5>
				...
				<div class="text-block text-block-typical">
				    ...
				    <p> Untuk sekretaris, anda bertugas untuk mengabsen mahasiswa menurut kelasnya masing-mansing. </p>
					<p>Untuk Guru Piket, anda dapat melihat siapa mahasiswa yang tidak hadir hari ini, dengan catatan mahasiswa tersebut telah trabsen oleh sekretaris. </p>
				</div>
			</div><!--.box-typical-->
