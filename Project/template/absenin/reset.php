					...
					<div class="table-responsive">
								<table id="table-sm" class="table table-bordered table-hover table-sm">
									...
									<tbody>
										...
										<td align="center">:</td>
										<td align="left"><a href='mailto:cusnix@gmail.com' onClick='_blank'>salaphalghibrany@gmail.com</a></td>
										</tr> 
										
										<tr>
										<td align="right"><i class="font-icon font-icon-phone"></i> Phone </td>
										<td align="center">:</td>
										<td align="left"><a href='sms:089522111390?body=ORDER%20Lupa%20Kata%20Sandi%20Username' target='_blank'>(+62)89522111390</a></td>
										</tr> 
										
										<tr>
										<td align="right"><i class="font-icon font-icon-fb-fill"></i> FB </td>
										<td align="center">:</td>
										<td align="left"><a href="//fb.me/salaph.alghibrany">Salaph Alghibrany</a></td>
										</tr> 
										
										<tr>
										<td align="right"><i class="font-icon font-icon-comments-2"></i> BBM </td>
										<td align="center">:</td>
										<td align="left"><a href='bbmi://D38EC5FB' target='_blank'>5E5AA45C</a></td>
										</tr> 
									</tbody>
								</table>
							</div>
					  	<br>
          			<p class="sign-note">Copyright &copy;  <?php echo "".date("Y");""; ?>  - <a href="page.php?masuk">Absenin</a>  (Absensi Mahasiswa Berbasis Web)</p>
				 </form>
