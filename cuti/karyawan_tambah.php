...
$cari_kd=mysql_query("select max(idx)as kode from karyawan"); //mencari kode yang paling besar atau kode yang baru masuk
          ...
          <div class="row">
            <div class="col-xs-12">
			   ...
			   <table id="example1" class="table table-condensed">
     					<form class="form-horizontal" role="form" method="post" action="karyawan_simpan.php">
     					<tr><td>
    						<div class="form-group">
        						<label for="name" class="col-sm-2 control-label">ID (otomatis)</label>
        						<div class="col-sm-1">
           						 	<input type="text" class="form-control"  name="idx" value="<?php echo $idp;?>" readonly="readonly"/> 
        						</div>
    					   </div>
    					</td></tr>
						<tr><td>
    						<div class="form-group">
        						...
        						<div class="col-sm-4">
           						 	<input type="date" class="form-control" id="tgl_masuk" name="tgl_masuk" required oninvalid="this.setCustomValidity">
        						</div>
    					   </div>
    					</td></tr>
    					<tr><td>
    						<div class="form-group">
        						...
        						<div class="col-sm-4">
           						 	<input type="text" class="form-control" id="nik" name="nik" placeholder="NIK Karyawan" required oninvalid="this.setCustomValidity">
        						</div>
    					   </div>
    					</td></tr>
						<tr><td>
    						<div class="form-group">
        						...
        						<div class="col-sm-4">
           						 	<input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Karyawan" required oninvalid="this.setCustomValidity">
        						</div>
    					   </div>
    					</td></tr>
						<tr><td>
    						<div class="form-group">
        						...
        						<div class="col-sm-4">
           						 	<input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" placeholder="Tempat Lahir" required oninvalid="this.setCustomValidity">
        						</div>
    					   </div>
    					</td></tr>
						<tr><td>
    						<div class="form-group">
        						...
        						<div class="col-sm-4">
           						 	<input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" placeholder="Tanggal Lahir" required oninvalid="this.setCustomValidity">
        						</div>
    					   </div>
    					</td></tr>
						<tr><td>
    						<div class="form-group">
        						...
        						<div class="col-sm-4">
           						 	<input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat" required oninvalid="this.setCustomValidity">
        						</div>
    					   </div>
    					</td></tr>
						<tr><td>
    						<div class="form-group">
        						...
        						<div class="col-sm-4">
           						 	<input type="text" class="form-control" id="hp" name="hp" placeholder="Nomor Telepon" required oninvalid="this.setCustomValidity">
        						</div>
    					   </div>
    					</td></tr>
							<tr><td>
    						<div class="form-group">
        						...
        						<div class="col-sm-4">
           						 <select class="form-control" name="departemen" required oninvalid="this.setCustomValidity">
						...
						<tr><td>
    						<div class="form-group">
        						<div class="col-sm-10 col-sm-offset-2">
            						<button type="submit" class="btn btn-primary" name="tombol">SIMPAN DATA KARYAWAN</button> 
        						</div>
    						</div>
    					</td></tr>	
		...
		<table  class="box table-condensed" border="1">
		 <h4>Data Karyawan</h4>
			...
			<thead>
                      <tr>
						<th width="80">NIK</th>
                      	<th width="350">Nama Karyawan</th>
						<th width="150">Telepon</th>
						<th width="150">Departemen</th>
						<th width="150">Status</th>
						<th width="150">Pilihan Admin</th>					
					</tr>	
                    </thead>
                        <tbody> 
                    <?php
						$mySql 	= "SELECT * FROM _karyawan";
						...
						<tr>
							...
							<td align="center"> <a href="karyawan_ubah.php?id=<?php echo $myData['idx']; ?>" onclick="return confirm('Yakin ingin merubah data karyawan ini?')">EDIT</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="karyawan_hapus.php?id=<?php echo $myData['idx']; ?>" onclick="return confirm('Yakin ingin hapus data karyawan ini?')">HAPUS</a></td>
						<?php } ?>
                    </tbody>      
                  </table>
				  </div>
