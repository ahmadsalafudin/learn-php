    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-xs-12">
			   ...
			   <table id="example1" class="table table-condensed">
     					<form class="form-horizontal" role="form" method="post" action="user_simpan.php">
     					<tr><td>
						...
						<tr><td>
    						<div class="form-group">
								...
								<small>Password default akan sama dengan username</small>
        						<div class="col-sm-4">
           						 	<input type="text" class="form-control" id="username" name="username" required oninvalid="this.setCustomValidity">
        						</div>
    					   </div>
    					</td></tr>
    					<tr><td>
    						<div class="form-group">
        						<label for="name" class="col-sm-2 control-label">Level Akses</label>
								<small>Khusus karyawan dengan jabatan Manager pilih level akses MANAGER</small>
        						<div class="col-sm-4">
           						 	<select class="form-control" name="level">
                     				 <?php 
                						$pilihan	= array("KARYAWAN", "NAMAGER", "ADMIN");
						...
						<tr><td>
    						<div class="form-group">
        						<div class="col-sm-10 col-sm-offset-2">
            						<button type="submit" class="btn btn-primary" name="tombol">SIMPAN DATA AKSES</button> 
        						</div>
    						</div>
    					</td></tr>	
		...
		<table  class="box table-condensed" border="1">
		 <h4>Data Karyawan Yang sudah Memiliki User Akses</h4>
